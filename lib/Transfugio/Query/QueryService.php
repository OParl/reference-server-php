...
class QueryService
{
   ...
   * <code>
   *   // an example closure
   *   function (array $unresolved, QueryService $query)
   *   {
   *      ...
   *   }
   * </code>
   ...
   * number of items per page stored in `transfugio.itemsPerPage`
   *
   * @return int
   * @see config/transfugio.php
   **/
  protected function getPaginationConfig()
  {
    ...
    return ($limit > 0) ? $limit : config('transfugio.itemsPerPage');
  }
