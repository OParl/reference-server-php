...
class Body extends Model {
  ...
  {
    return $this->belongsTo('OParl\Model\System', 'system_id', 'id');
  }
  ...
  {
    return $this->hasMany('OParl\Model\Organization');
  }
  ...
  {
    return $this->hasMany('OParl\Model\Person');
  }
  ...
  {
    return $this->hasMany('OParl\Model\LegislativeTerm');
  }
}
